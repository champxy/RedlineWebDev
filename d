...
file:.git/config	remote.origin.url=https://github.com/w3-devmaster/estate.git
file:.git/config	remote.origin.fetch=+refs/heads/*:refs/remotes/origin/*
file:.git/config	branch.main.remote=origin
file:.git/config	branch.main.merge=refs/heads/main
file:.git/config	branch.menn.remote=origin
file:.git/config	branch.menn.merge=refs/heads/menn
file:.git/config	gui.wmstate=normal
file:.git/config	gui.geometry=893x435+328+210 175 196
