...
@section('content_header')
    ...
    <div class="row">
        <h5 class="mx-2"><a href="{{ route('admin.adminSetting.index') }}">ตั้งค่า</a> / </h5>
        <h5 class="text-dark">เพิ่มสถานีใหม่</h5>
    </div>
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-xl-12">
                <div class="card py-2" style="border-radius: 15px;">
                    <div class="card-body">
                        <form action="{{route('admin.setting.store.station')}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('post')
                            <div class="row">
                                <div class="col-12 col-md-6 col-xl-4 overflow-auto">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mb-2 form-control-sm" name="station_name"
                                            id="station_name" aria-describedby="helpId" placeholder="กรอกชื่อสถานี"
                                            value="">
                                    </div>
                                    <div class="form-group">
                                            <label class="text-sm" for="facility_select">สิ่งอำนวยความสะดวก</label><br>
                                            <select id="facility_select"
                                                class="facility_select form-select form-select-sm shadow-sm"
                                                name="facilities[]" multiple="multiple">
        
                                                @foreach ($fac_all as $key => $facty)
                                                    <option value="{{ $key }}">{{ $facty['fac_name'] }}</option>
                                                @endforeach
                                            </select>
        
                                            <label class="mt-2 text-sm" for="central_select">Location_set :
                                                Longitude/Latitude</label><br>
                                            <div class="form-inline">
                                                <input type="number" step="any" class="form-control mb-2 form-control-sm"
                                                    id="longtitude" name="longtitude" placeholder="ลองติจูด"
                                                    aria-describedby="helpId" value="">
                                                <input type="number" step="any" class="form-control mb-2 form-control-sm ml-2"
                                                    id="latitude" name="latitude" placeholder="ละติจูด"
                                                    aria-describedby="helpId" value="">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mb-2 form-control-sm" name="exit_name"
                                            id="exit_name" aria-describedby="helpId" placeholder="กรอกชื่อทางออก"
                                            value="">
                                        <label class="mt-2" for="exdors_detail">ทางออก</label>
                                        <textarea type="text" class="form-control mb-2 form-control-sm" name="exdors_detail" id="exdors_detail"
                                            aria-describedby="helpId" placeholder="กรอกรายละเอียดอทางออก"></textarea>
                                    </div>
                                ...
                                <div class="col-12 col-md-3 col-xl-4 overflow-auto">
                                    <div class="card border-secondary mb-2">
                                        <div class="card-header pb-2" style="background-color: #F5F5F5">
                                            ...
                                            <a type="button" id="add_in" class="text-success ml-auto"><i
                                                    class="fa fa-plus-circle" aria-hidden="true"></i></a>
                                            <a type="button" id="remove_in" class="text-secondary"><i
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row-markingIn">
                                                ...
                                                <div class="row mb-2 row_in">
                                                    <div class="col-12 col-md-3 col-xl-4 overflow-auto">
                                                        <input type="number" step="any" class="form-control form-control-sm" id="in_latitude[]"
                                                            name="in_latitude[]" placeholder="Latitude" value="">
                                                    </div>
                                                    <div class="col-12 col-md-3 col-xl-4 overflow-auto">
                                                        <input type="number" step="any" class="form-control form-control-sm" id="in_longitude[]"
                                                            name="in_longitude[]" placeholder="Longitude" value="">
                                                    </div>
                                                    <div class="col-12 col-md-3 col-xl-4 overflow-auto">
                                                        <input type="number" step="any" class="form-control form-control-sm" id="in_attitude[]"
                                                            name="in_attitude[]" placeholder="Attitude" value="">
                                                    </div>
                                                </div>
                                ...
                                <div class="col-12 col-md-3 col-xl-4 overflow-auto">
                                    <div class="card border-secondary mb-2">
                                        <div class="card-header pb-2" style="background-color: #F5F5F5">
                                            ...
                                            <a type="button" id="add_out" class="text-success ml-auto"><i
                                                    class="fa fa-plus-circle" aria-hidden="true"></i></a>
                                            <a type="button" id="remove_out" class="text-secondary"><i
                                                    class="fa fa-minus-circle" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="card-body">
                                            <div class="row mb-2">
                                            ...
                                            <div class="row-markingOut">
                                                ...
                                                <div class="row mb-2 row_out">
                                                    <div class="col-12 col-md-3 col-xl-4 overflow-auto">
                                                        <input class="form-control form-control-sm" id="out_latitude[]"
                                                            name="out_latitude[]" placeholder="Latitude" value="">
                                                    </div>
                                                    <div class="col-12 col-md-3 col-xl-4 overflow-auto">
                                                        <input class="form-control form-control-sm" id="out_longitude[]"
                                                            name="out_longitude[]" placeholder="Longitude"
                                                            value="">
                                                    </div>
                                                    <div class="col-12 col-md-3 col-xl-4 overflow-auto">
                                                        <input class="form-control form-control-sm" id="out_attitude[]"
                                                            name="out_attitude[]" placeholder="Attitude" value="">
                                                    </div>
                                                </div>
        ...
        $(document).ready(function() {
            $('#addTransport').click(function() {
                var newCard = $('<div class="card border-secondary mb-2 card_trans">' +
                    ...
                    '<input type="text" class="form-control form-control-sm mr-2" name="tran_desc1_' +
                    cardCount +
                    '[]" id="tran_desc" aria-describedby="helpId" placeholder="สายรถ / เบอร์รถ">' +
                    '<input type="text" class="form-control form-control-sm" name="tran_desc2_' +
                    cardCount +
                    '[]" id="tran_desc" aria-describedby="helpId" placeholder="สถานที่ที่รถเดินทาง"><br>' +
        ...
        $(document).ready(function() {
            $('.add_desc').click(function() {
                ...
                var newCard = $('<div class="form-inline mb-1 desc_tran">' +
                    '<input type="text" class="form-control form-control-sm mr-2" name="tran_desc1_' +
                    keyDesc + '[]" id="tran_desc"  placeholder="สายรถ / เบอร์รถ" value=""> ' +
                    '<input type="text" class="form-control form-control-sm" name="tran_desc2_' +
                    keyDesc + '[]" id="tran_desc" placeholder="สถานที่ที่รถเดินทาง" value="">' +
                    '<br>' +
                    '<button class="btn btn-outline-secondary ml-1 btn-sm remove_desc"> - </button>' +
                    '</div>');
